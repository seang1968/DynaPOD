...
from tests.test_data_operation_manager import TestDataOperationManager
from tests.test_pairs_config_manager import TestPairsConfigManager
# Create a test suite
...
#suite.addTests(unittest.TestLoader().loadTestsFromTestCase(TestDataOperationManager))
#suite.addTests(unittest.TestLoader().loadTestsFromTestCase(TestPairsConfigManager))
